...
ODS Graphics ON /reset=All imagename="&tema._&type._ratetodelt_&fignavn" imagefmt=png border=off ;
*DS Graphics ON /reset=All imagename="&tema._&type._ratetodelt_&fignavn" imagefmt=png border=off ;
