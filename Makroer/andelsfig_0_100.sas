%macro andelsfig_0_100(n_datasett=, text_a1=, sortby=andel_ds1, bildeformat=png, noxlabel=0, sprak=en);
...
*where bohf ne 8888;
	...
	Yaxistable andel_ds1 /*&tabellvariable*/ /Label="&text_a1" location=inside labelpos=bottom position=right valueattrs=(size=8 family=arial) labelattrs=(size=8);
