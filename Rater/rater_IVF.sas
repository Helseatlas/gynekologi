...
%Let ratevariabel = IVF Egg overføring (LCA39, LCW30K); /*Brukes til å lage "pene" overskrifter*/
...
/******  DATAGRUNNLAG  ****************************************************************/
%let RV_variabelnavn= tot; /*navn på ratevariabel i det aggregerte datasettet*/
%Let ratevariabel = IUI - Intrauterin inseminasjon (LCGX20); /*Brukes til å lage "pene" overskrifter*/
%Let forbruksmal = &agg_var; /*Brukes til å lage tabell-overskrift i Årsvarfig, gir også navn til 'ut'-datasett*/
