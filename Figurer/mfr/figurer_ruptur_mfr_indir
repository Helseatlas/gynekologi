...
%let tittel=Antall førstegangsfødsler med ruptur grad 3/4, INDIREKTEJUST per. 10 000 vaginale førstegangsfødsler. Gjennomsnitt per år i perioden 2015-17.;
...
%ratefig(datasett=&tema._par0_Par0vagIJ_bohf, aar1=2015, aar2=2016, aar3=2017);
...
%let tittel=Antall flergangsfødsler med ruptur grad 3/4, per. INDIREKTEJUST10 000 vaginale flergangsfødsler. Gjennomsnitt per år i perioden 2015-17.;
...
%ratefig(datasett=&tema._par1_Par1vagIJ_bohf, aar1=2015, aar2=2016, aar3=2017);
