...
%let type=inngr;
%let tittel=Innleggelser som andel av alle inngrep for genitalt prolaps. Aldersstandardiserte rater. Gjennomsnitt per år i perioden 2014-16.;
...
%let type=inngr;
%let tittel=Liggetid per inngrep, kirurgisk behandling for genitalt prolaps. Aldersstandardiserte rater. Gjennomsnitt per år i perioden 2014-16.;
