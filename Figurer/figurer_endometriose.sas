...
/***************************************************************/
/* Lag tredelt figur for teknikker - åpen, lapraskopi, hysterektomi */
/***************************************************************/
...
%let label_2=Åpen;
%let label_3=Hyst;
%let labeltabell=&tabellvar1="Lap" &tabellvar2="Åpen" &tabellvar3="Hyst";
...
%let type=inngr;
%let tittel=Liggetid per inngrep, kirurgisk behandling for endometriose. Aldersstandardiserte rater. Gjennomsnitt per år i perioden 2015-17.;
