...
%let fignavn=offpriv;
%let type=unders;
%let tittel=Antall polikliniske undersøkelser med endometriebiopsi per 100 000 innbyggere. Aldersstandardiserte rater. Gjennomsnitt per år i perioden 2014-16.;
%let xlabel= Polikliniske undersøkelser med endometriebiopsi, pr. 100 000 innbyggere. Aldersjusterte rater.;
