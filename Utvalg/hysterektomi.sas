...
array Prosedyre {*} NC:;
	...
	if prosedyre{i} in ('LCD00','LCD30','LCD96','LCC10') then Hysterektomi_Aapen_p=1;
	if prosedyre{i} in ('LCD10','LCD40','LEF13','LCC20') then Hysterektomi_Vaginal_p=1;
	if prosedyre{i} in ('LCD01','LCD04','LCD11','LCD31','LCD97','LCC11') then Hysterektomi_Lap_p=1;
